...
$sql = "insert into entries(ORGANIZATION,OWNER,QUEUE_NAME,ENTRY_STATUS,QUEUED_FOR_ROLE,BUSINESS_PROCESS,ACTIVITY,CREATION_DATE,JOB_ID) values('$org','$creator','$application','$status','$queued_for_role','$process','$activity','$today',0)";
